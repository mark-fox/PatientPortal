...
create table patients (id bigint not null, dob date, email varchar(255), firstname varchar(255) not null, gender varchar(255), lastname varchar(255) not null, lastvisit date, phone varchar(255), ethnicity varchar(255), doc_id bigint, primary key (id)) engine=InnoDB;
